module mem
    ...
    subroutine allocate_mem
        ...
        allocate (rvp_xadv(nx,ny,nz))
        allocate (rvp_yadv(nx,ny,nz))
        allocate (rvp_zadv(nx,ny,nz))
        allocate (rvp_meanadv(nx,ny,nz))
        allocate (rvp_xdiff(nx,ny,nz))
        allocate (rvp_ydiff(nx,ny,nz))
        allocate (rvp_zdiff(nx,ny,nz))
        allocate (rvp_tend_total(nx,ny,nz))
        allocate (rcp_xadv(nx,ny,nz))
        allocate (rcp_yadv(nx,ny,nz))
        allocate (rcp_zadv(nx,ny,nz))
        allocate (rcp_xdiff(nx,ny,nz))
        allocate (rcp_ydiff(nx,ny,nz))
        allocate (rcp_zdiff(nx,ny,nz))
        allocate (rcp_tend_total(nx,ny,nz))
        allocate (rrp_xadv(nx,ny,nz))
        allocate (rrp_yadv(nx,ny,nz))
        allocate (rrp_zadv(nx,ny,nz))
        allocate (rrp_xdiff(nx,ny,nz))
        allocate (rrp_ydiff(nx,ny,nz))
        allocate (rrp_zdiff(nx,ny,nz))
        allocate (rrp_tend_total(nx,ny,nz))
    ...
    subroutine deallocate_mem
        ...
        deallocate (thp_heating(nx,ny,nz))
        ...
        deallocate (rvp_xadv(nx,ny,nz))
        deallocate (rvp_yadv(nx,ny,nz))
        deallocate (rvp_zadv(nx,ny,nz))
        deallocate (rvp_meanadv(nx,ny,nz))
        deallocate (rvp_xdiff(nx,ny,nz))
        deallocate (rvp_ydiff(nx,ny,nz))
        deallocate (rvp_zdiff(nx,ny,nz))
        deallocate (rvp_tend_total(nx,ny,nz))
        deallocate (rcp_xadv(nx,ny,nz))
        deallocate (rcp_yadv(nx,ny,nz))
        deallocate (rcp_zadv(nx,ny,nz))
        deallocate (rcp_xdiff(nx,ny,nz))
        deallocate (rcp_ydiff(nx,ny,nz))
        deallocate (rcp_zdiff(nx,ny,nz))
        deallocate (rcp_tend_total(nx,ny,nz))
        deallocate (rrp_xadv(nx,ny,nz))
        deallocate (rrp_yadv(nx,ny,nz))
        deallocate (rrp_zadv(nx,ny,nz))
        deallocate (rrp_xdiff(nx,ny,nz))
        deallocate (rrp_ydiff(nx,ny,nz))
        deallocate (rrp_zdiff(nx,ny,nz))
        deallocate (rrp_tend_total(nx,ny,nz))
