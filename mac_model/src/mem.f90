module mem
    use run_constants, only: nz,nx,mpb,ndb,bin_flag
    use model_vars
    ...
    subroutine allocate_mem
        ...
        allocate(np(nx,nz,mpb,3))
        allocate(mp(nx,nz,mpb,3))
        allocate(nc(nx,nz,mpb,ndb,3))
        allocate(mc(nx,nz,mpb,ndb,3))
        allocate(mpc(nx,nz,mpb,ndb,3))
        allocate(nr(nx,nz,mpb,ndb,3))
        allocate(mr(nx,nz,mpb,ndb,3))
        allocate(mpr(nx,nz,mpb,ndb,3))
        ...
        allocate(np_tend_total(nx,nz,mpb))
        allocate(mp_tend_total(nx,nz,mpb))
        allocate(nc_tend_total(nx,nz,mpb,ndb))
        allocate(mc_tend_total(nx,nz,mpb,ndb))
        allocate(mpc_tend_total(nx,nz,mpb,ndb))
        allocate(nr_tend_total(nx,nz,mpb,ndb))
        allocate(mr_tend_total(nx,nz,mpb,ndb))
        allocate(mpr_tend_total(nx,nz,mpb,ndb))
    ...
    subroutine deallocate_mem
        ...
        deallocate(np(nx,nz,mpb,3))
        deallocate(mp(nx,nz,mpb,3))
        deallocate(nc(nx,nz,mpb,ndb,3))
        deallocate(mc(nx,nz,mpb,ndb,3))
        deallocate(mpc(nx,nz,mpb,ndb,3))
        deallocate(nr(nx,nz,mpb,ndb,3))
        deallocate(mr(nx,nz,mpb,ndb,3))
        deallocate(mpr(nx,nz,mpb,ndb,3))
        ...
        deallocate(np_tend_total(nx,nz,mpb))
        deallocate(mp_tend_total(nx,nz,mpb))
        deallocate(nc_tend_total(nx,nz,mpb,ndb))
        deallocate(mc_tend_total(nx,nz,mpb,ndb))
        deallocate(mpc_tend_total(nx,nz,mpb,ndb))
        deallocate(nr_tend_total(nx,nz,mpb,ndb))
        deallocate(mr_tend_total(nx,nz,mpb,ndb))
        deallocate(mpr_tend_total(nx,nz,mpb,ndb))
